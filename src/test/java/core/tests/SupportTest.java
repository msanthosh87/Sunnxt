...
import core.pages.HomePageMobile;
import core.pages.HomePageWeb;
import core.pages.LoginPageMobile;
import core.pages.LoginPageWeb;
...
public class SupportTest {
	...
	public HomePageMobile homeMobile;
	public LoginPageMobile loginMobile;
	public HomePageWeb homeWeb;
	public LoginPageWeb loginWeb;
	...
	public void runOncePerMethod(ITestContext context, Method method) throws Exception {
		...
		homeMobile = new HomePageMobile(conf, agent, testData);
		loginMobile = new LoginPageMobile(conf, agent, testData);
		homeWeb = new HomePageWeb(conf, agent, testData);
		loginWeb = new LoginPageWeb(conf, agent, testData);
